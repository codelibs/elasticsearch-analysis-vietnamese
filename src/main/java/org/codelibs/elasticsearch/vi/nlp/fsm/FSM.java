...
public abstract class FSM {
     ...
     * @param t
     */
    private void addIntransitionMap(final Transition t) {
    ...
    public void addTransition(final Transition t) {
        if (t != null) {
            ...
            final State source = states.get(t.getSource());
     ...
     */
    public Transition getTransition(final int src, final int tar) {
        final State s = getState(src);
        final List<Transition> outTransitions = s.getOutTransitions();
     ...
     */
    public State getNextState(final State currentState, final char input) {
        for (final Transition t : currentState.getOutTransitions()) {
            if (t.getInput() == input) {
     ...
     * @return the output
     */
    public String getNextOutput(final State currentState, final char input) {
        for (final Transition t : currentState.getOutTransitions()) {
            if (t.getInput() == input) {
                return t.getOutput();
            }
