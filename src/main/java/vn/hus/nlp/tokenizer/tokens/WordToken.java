...
public class WordToken extends TaggedWord {
	 ...
	 */
	public WordToken(final LexerRule rule, final String text, final int line, final int column) {
	 ...
	 */
	public WordToken(final LexerRule rule, final String text, final int line, final int column, final String pos) {
		super(rule, text, line, column);
		this.pos = pos;
	}
